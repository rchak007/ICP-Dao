...
import { idlFactory } from './level_4.did.js';
export { idlFactory } from './level_4.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LEVEL_4_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./level_4.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the level_4 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./level_4.did.js")._SERVICE>}
 */
export const level_4 = createActor(canisterId);
